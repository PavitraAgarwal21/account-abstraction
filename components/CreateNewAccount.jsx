            ...
            <div className='fixed backdrop-filter backdrop-blur top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg p-4 max-w-md w-full sm:max-w-sm'>
                {created ? (
                    <div className='flex flex-col'>
                        <h1 className='text-xl font-bold mb-6 text-black'>Create New Wallet</h1>
                        <p className='text-green-500 font-bold mb-6 text-black'>Wallet created successfully!</p>
                    ...
                    <div>
                        <h1 className='text-xl font-bold mb-6 text-black'>Create New Wallet</h1>
                        <h1 className='text-md mb-6 text-black'>
