        ...
        <div className=''>
            {!popUp ? (
                ...
                <div className='fixed top-0 lg:m-0  left-0 right-0 bottom-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50'>
                    <div className='bg-bloack w-full sm:max-w-md rounded-lg overflow-hidden shadow-xl lg:mx-0 mx-5'>
                        <div className='p-4'>
                            ...
                            {transactionHash
                                ...
                                <form>
                                    <div className='mb-4 '>
                                        <label className='block font-bold mb-2 text-white' htmlFor='send-address'>
                                            Address
                                        </label>
                                        <input
                                    ...
                                    <div className='mb-4'>
                                        <label className='block font-bold mb-2 text-white' htmlFor='amount'>
                                            Amount
                                        </label>
                                        <input
                                            className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:border-blue-500'
