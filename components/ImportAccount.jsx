    ...
    return (
        <div class="backdrop-filter backdrop-blur-sm fixed inset-0 z-50">
            <div className='fixed backdrop-filter backdrop-blur top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg p-4 max-w-md w-full'>
                <h1 className='text-lg font-bold mb-6 text-black'>Import Account</h1>
                <div className="mb-4">
                    <label className="block font-bold mb-2 text-black" htmlFor="importedPrivateKey">
                        Enter Private Key
                    </label>
                    <input
                ...
                {fetch ? (
                    ...
                    <div className='flex justify-end mt-6'>
                        ...
                        <button
                            className='bg-blue-500 hover:bg-blue-600 text-black py-2 px-4 rounded-lg '
