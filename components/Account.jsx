    ...
    return (
        <div className="">
            <div className="flex items-center pb-2">
                <h1 className="lg:text-3xl text-xl font-bold t">Account 1</h1>
            ...
            <div className="flex items-start lg:items-center mt-5 lg:mt-10">
                <h1 className="lg:text-lg text-base font-bold text-white">Address:</h1>
            ...
            <div className="flex items-center mt-4 lg:mt-6">
                <h1 className="lg:text-lg text-base font-bold text-white">Balance:</h1>
